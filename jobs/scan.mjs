...
export { compileKeyword, buildTitleFilter, buildLocationFilter, buildContentFilter } from './lib/filters.mjs';
...
async function main() {
  ...
  resolveEntries(boardsOnly ? [] : companies);
  ...
  if (jsonOut) {
    const boardsScanned = targets.filter((t) => t._isBoard).length;
    process.stdout.write(JSON.stringify({
      date,
      boardsOnly,
      boardsScanned,
      totalFound,
      matches: verifiedOffers.length,
